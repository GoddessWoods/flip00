...
\hspace*{0.3cm}1.1 Problem Summary\\
...
\begin{table}[htbp]  \centering
	...
	\end{tabular}
\end{table}
\hspace*{0.4cm}2.2 Data Visualization
\hspace*{0.4cm}In order to observate the data intuitively, use the data to plot some figures which show the 
