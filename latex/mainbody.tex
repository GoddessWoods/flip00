...
\begin{itemize}
	...
	\begin{description}
		...
		\item[Netual Network] 'activation': 'relu', 'hidden_layer_sizes': 9, 'learning_rate': 'adaptive', 'solver': 'adam'
	\end{description}
	...
	\begin{table}[h]  \centering
		...
		\begin{tabular}{ccccccccc}
			...
			0.7547 & 0.7493 & 0.7251 & 0.9314 & 0.7466\\
			\hline 
			%\bottomrule
		\end{tabular}
	\end{table}
...
\begin{itemize}
	...
	\begin{table}[h]  \centering
		...
		\begin{tabular}{ccccccccc}
			...
			\hline
			Best Score & 0.7224 & 0.7251 & 0.7385 & 
			0.7547 & 0.7493 & 0.7251 & 0.9326 & 0.7466\\
			\hline 
			%\bottomrule
		\end{tabular}
	\end{table}
...
%\begin{table}[h]  \centering
	...
	%\hline
	% after \\: \hline or \cline{col1-col2} \cline{col3-col4} ...
	%Models& RandomForest & Bagging & GradientBoosting & 
	%LogisticRegression & SVC & KNeighbors & XGBoost & Netual Network & Ensemble\\
	%\hline
	%Accuracy_old & 0.8133 & 0.6800 & 0.8800 & 
	%0.7600 & 0.7467 & 0.7333 & 0.9200 & 0.7333 & 0.7867\\
	%Accuracy_new & 0.8267 & 0.7200 & 0.7866 &
	%0.7333 & 0.6933 & 0.7067 & 0.9467 &0.68 & 0.8667\\
