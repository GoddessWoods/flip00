...
\begin{figure}[htbp]\centering
	...
	\includegraphics[scale=0.3]{bar.eps}
	\caption{name}
\end{figure}
...
\begin{figure}[htbp]\centering
	...
	\includegraphics[scale=0.3]{his_1.eps}
	\caption{mean}
\end{figure}
...
\begin{figure}[htbp]\centering
	%\graphicspath{{figures/}{mine/}}
	\includegraphics[scale=0.3]{his_2.eps}
	\caption{color}
\end{figure}
...
\begin{figure}[h]\centering
	%\graphicspath{{figures/}{mine/}}
	\includegraphics[scale=0.3]{boxplot.eps}
...
\begin{figure}[h]\centering
	%\graphicspath{{figures/}{mine/}}
	\includegraphics[scale=0.3]{pairplot.eps}
...
\begin{figure}[h]\centering
	%\graphicspath{{figures/}{mine/}}
	\includegraphics[scale=0.3]{corr.eps}
