...
\block{Data Visualization}{
	...
	\begin{center}
		\includegraphics[width=.3\linewidth]{figures/boxplot.eps}
		\quad\includegraphics[width=.3\linewidth]{figures/his_1.eps}
		\quad\includegraphics[width=.3\linewidth]{figures/his_2.eps}
...
\begin{center}
    ...
    \centering
    \begin{tikzfigure}
    \missingfigure[figcolor=white]{figures/boxplot.eps}
