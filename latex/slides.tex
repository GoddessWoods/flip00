...
\newcommand{\wenbin}[1]{\draftnote{green}{wb:}{#1}}
\newcommand{\mumu}[1]{\draftnote{red}{sx:}{#1}}
\newcommand{\gliMarker}
	{\todo[author=GLi,size=\tiny,inline,color=blue!40]
	{Gang Li has worked up to here.}}
\newcommand{\wbMarker}
	{\todo[author=wb,size=\tiny,inline,color=green!40]
		{WenbinJ has worked up to here.}}
\newcommand{\mumuMarker}
{\todo[author=sx,size=\tiny,inline,color=green!40]
	{sx has worked up to here.}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% title
...
cf={Flip 00 Project Final Report},
}
...
\twotonebox{\rotatebox{90}{Defn}}{\parbox{.86\textwidth}
{
	...
	The raw dataset contains train set with \textcolor{orange}{371} samples 
	and \textcolor{orange}{529} unlabeled samples as test set.
