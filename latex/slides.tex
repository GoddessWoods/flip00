...
\newcommand{\wb}[1]{\draftnote{green}{wb:}{#1}}
\newcommand{\mumu}[1]{\draftnote{red}{mumu:}{#1}}
\newcommand{\gliMarker}
	{\todo[author=GLi,size=\tiny,inline,color=blue!40]
	{Gang Li has worked up to here.}}
\newcommand{\wbMarker}
	{\todo[author=wb,size=\tiny,inline,color=green!40]
	{wb has worked up to here.}}
\newcommand{\mumuMarker}
{\todo[author=mumu,size=\tiny,inline,color=red!40]
	{mumu has worked up to here.}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% title
% TODO: Customize to your Own Title, Name, Address
%
\title{Flip00 Project Final Test Presentationn}
\author{
Shuxia Lin
\\
...
cf={Flip00 Project Final Test Presentationn},
}
...
\begin{slide}{Data Set}
	\begin{center}
		\twotonebox{\rotatebox{90}{Info}}{\parbox{.88\textwidth}
			{
