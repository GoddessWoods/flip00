...
\begin{center}
	\includegraphics[width=.5\linewidth]{figures/his_1.eps}
	\quad\includegraphics[width=.5\linewidth]{figures/his_2.eps}
\end{center}
\end{slide}
%%
%%==========================================================================================
...
\begin{slide}[toc=,bm=]{Data Visualize}
	...
	\begin{center}
		\includegraphics[width=.5\linewidth]{figures/boxplot.eps}
		\quad\includegraphics[width=.5\linewidth,height=.25\linewidth]{figures/corr.eps}	
	\end{center}
\end{slide}
